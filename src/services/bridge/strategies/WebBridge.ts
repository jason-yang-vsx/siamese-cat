...
const MOCK_STUDENTS: Student[] = [
  { studentId: '1', name: '王小明', seatNumber: '1' },
  { studentId: '2', name: '李小華', seatNumber: '2' },
  { studentId: '3', name: '張大同', seatNumber: '3' },
  { studentId: '4', name: '陳美麗', seatNumber: '4' },
  { studentId: '5', name: '林志強', seatNumber: '5' },
  { studentId: '6', name: '黃雅婷', seatNumber: '6' },
  { studentId: '7', name: '劉建國', seatNumber: '7' },
  { studentId: '8', name: '吳淑芬', seatNumber: '8' },
  { studentId: '9', name: '楊志偉', seatNumber: '9' },
  { studentId: '10', name: '許文彬', seatNumber: '10' },
  { studentId: '11', name: '謝明珠', seatNumber: '' }, // 測試空座號
  { studentId: '12', name: '蔡雅玲', seatNumber: '12' },
  { studentId: '13', name: '鄭大勇', seatNumber: '13' },
  { studentId: '14', name: '趙小美', seatNumber: '14' },
  { studentId: '15', name: '周建華', seatNumber: '15' }
];
